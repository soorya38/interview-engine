        ...
        <div className="p-8 space-y-6 max-w-7xl mx-auto">
            <div>
                ...
                <p className="text-muted-foreground">
                    Choose a session to practice your skills
                </p>
            </div>
            ...
            {filteredTests && filteredTests.length > 0 ? (
                        ...
                        <Card key={test.id} className="hover-elevate" data-testid={`test-card-${test.id}`}>
                            <CardHeader>
                                ...
                                <CardDescription className="line-clamp-2">
                                    {test.description || "Practice questions on this topic"}
                                </CardDescription>
                            </CardHeader>
                ...
                <Card className="p-12">
                    <div className="text-center text-muted-foreground">
                        ...
                        <p className="text-lg mb-2">No practice sessions found</p>
                        <p className="text-sm">
                            {searchQuery ? "Try a different search term" : "No practice sessions available yet"}
                        </p>
                    </div>
                </Card>
            )}
